...
var app = (function () {
    ...
    /* src/tristate.svelte generated by Svelte v3.59.1 */
    const file$2 = "src/tristate.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input, "class", "svelte-1synwaa");
    			add_location(input, file$2, 21, 2, 854);
    			set_style(label, "color", /*color*/ ctx[1]);
    			attr_dev(label, "class", "svelte-1synwaa");
    			add_location(label, file$2, 20, 0, 821);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(input, "click", /*click_handler*/ ctx[5], false, false, false, false);
    				mounted = true;
    			}
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	const click_handler = () => dispatch('click', state);
    	...
    	return [state, color, dispatch, $$scope, slots, click_handler];
    }
    ...
    const makeTodayEntry = () => {
        ...
        // initialize successes to empty dict
        return {date: TODAY_DATE, successes: {}};
    };

    const writeEntry = async (date, successes) => {
        ...
        // Ensure the date is a valid ISO date
    ...
    /* src/DailyLog.svelte generated by Svelte v3.59.1 */

    const file$1 = "src/DailyLog.svelte";
    ...
    // (35:12) <Tristate state={successes[resolution.id]} on:click={(event) => {successes[resolution.id] = cycle_state(event.detail); update_entry()}} >
    function create_default_slot(ctx) {
    	let t0_value = /*resolution*/ ctx[8].text + "";
    	let t0;
    	let t1;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(35:12) <Tristate state={successes[resolution.id]} on:click={(event) => {successes[resolution.id] = cycle_state(event.detail); update_entry()}} >",
    		ctx
    	});
    ...
    // (34:8) {#each resolutions.filter(resolution => resolution.person === person) as resolution, i}
    function create_each_block_1(ctx) {
    	let tristate;
    	let current;

    	function click_handler(...args) {
    		return /*click_handler*/ ctx[4](/*resolution*/ ctx[8], ...args);
    	}

    	tristate = new Tristate({
    			props: {
    				state: /*successes*/ ctx[0][/*resolution*/ ctx[8].id],
    	...
    	tristate.$on("click", click_handler);

    	const block = {
    		c: function create() {
    			create_component(tristate.$$.fragment);
    		},
    		m: function mount(target, anchor) {
    			mount_component(tristate, target, anchor);
    			current = true;
    		},
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			const tristate_changes = {};
    			if (dirty & /*successes*/ 1) tristate_changes.state = /*successes*/ ctx[0][/*resolution*/ ctx[8].id];

    			if (dirty & /*$$scope*/ 1024) {
    				tristate_changes.$$scope = { dirty, ctx };
    			}

    			tristate.$set(tristate_changes);
    		},
    		i: function intro(local) {
    			if (current) return;
    			transition_in(tristate.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(tristate.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			destroy_component(tristate, detaching);
    		}
    	};
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(34:8) {#each resolutions.filter(resolution => resolution.person === person) as resolution, i}",
    		ctx
    	});
    ...
    // (31:4) {#each persons as person, i}
    function create_each_block$1(ctx) {
    	let h3;
    	let t0_value = /*person*/ ctx[5] + "";
    	let t0;
    	let t1;
    	let each_1_anchor;
    	let current;
    	...
    	function func(...args) {
    		return /*func*/ ctx[3](/*person*/ ctx[5], ...args);
    	}

    	let each_value_1 = resolutions.filter(func);
    	...
    	const block = {
    		c: function create() {
    			...
    			each_1_anchor = empty();
    			attr_dev(h3, "class", "svelte-t305wb");
    			add_location(h3, file$1, 31, 8, 972);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*successes, resolutions, persons, cycle_state, update_entry*/ 5) {
    				each_value_1 = resolutions.filter(func);
    				validate_each_argument(each_value_1);
    				let i;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(31:4) {#each persons as person, i}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h2, "class", "svelte-t305wb");
    			add_location(h2, file$1, 29, 4, 915);
    			attr_dev(main, "class", "svelte-t305wb");
    			add_location(main, file$1, 28, 0, 904);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (!current || dirty & /*date*/ 2) set_data_dev(t0, /*date*/ ctx[1]);

    			if (dirty & /*resolutions, persons, successes, cycle_state, update_entry*/ 5) {
    				each_value = persons;
    				validate_each_argument(each_value);
    				let i;
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('DailyLog', slots, []);
    	let { date = new Date().toISOString().slice(0, 10) } = $$props;
    	let { successes = {} } = $$props;
    	...
    	const writable_props = ['date', 'successes'];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<DailyLog> was created with unknown prop '${key}'`);
    	});

    	const func = (person, resolution) => resolution.person === person;

    	const click_handler = (resolution, event) => {
    		$$invalidate(0, successes[resolution.id] = cycle_state(event.detail), successes);
    		update_entry();
    	};

    	$$self.$$set = $$props => {
    		if ('date' in $$props) $$invalidate(1, date = $$props.date);
    		if ('successes' in $$props) $$invalidate(0, successes = $$props.successes);
    	};
    	...
    	return [successes, date, update_entry, func, click_handler];
    }

    class DailyLog extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { date: 1, successes: 0 });
    	...
    	get date() {
    		throw new Error("<DailyLog>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set date(value) {
    		throw new Error("<DailyLog>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    ...
    // (10:1) {#each entry_list as entry (entry.date)}
    function create_each_block(key_1, ctx) {
    	...
    	dailylog = new DailyLog({
    			props: {
    				date: /*entry*/ ctx[2].date,
    				successes: /*entry*/ ctx[2].successes
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		c: function create() {
    			first = empty();
    			create_component(dailylog.$$.fragment);
    			this.first = first;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, first, anchor);
    			mount_component(dailylog, target, anchor);
    			current = true;
    		},
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			const dailylog_changes = {};
    			if (dirty & /*entry_list*/ 1) dailylog_changes.date = /*entry*/ ctx[2].date;
    			if (dirty & /*entry_list*/ 1) dailylog_changes.successes = /*entry*/ ctx[2].successes;
    			dailylog.$set(dailylog_changes);
    		},
    		i: function intro(local) {
    			if (current) return;
    			transition_in(dailylog.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(dailylog.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(first);
    			destroy_component(dailylog, detaching);
    		}
    	};
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(10:1) {#each entry_list as entry (entry.date)}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	let current;
    	let each_value = /*entry_list*/ ctx[0];
    	validate_each_argument(each_value);
    	const get_key = ctx => /*entry*/ ctx[2].date;
    	...
    	const block = {
    		c: function create() {
    			main = element("main");
    			h1 = element("h1");
    			h1.textContent = "NEW YEAR'S RESOLUTIONS";
    			t1 = space();
    			...
    			attr_dev(h1, "class", "svelte-baydyd");
    			add_location(h1, file, 7, 1, 212);
    			attr_dev(main, "class", "svelte-baydyd");
    			add_location(main, file, 6, 0, 204);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*entry_list*/ 1) {
    				each_value = /*entry_list*/ ctx[0];
    				validate_each_argument(each_value);
    				group_outros();
    				validate_each_keys(ctx, each_value, get_each_context, get_key);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ DailyLog, entries, entry_list, $entries });

    	$$self.$inject_state = $$props => {
    		if ('entry_list' in $$props) $$invalidate(0, entry_list = $$props.entry_list);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*$entries*/ 2) {
    			$$invalidate(0, entry_list = [...Object.values($entries)].sort((a, b) => new Date(b.date) - new Date(a.date)));
    		}
    	};
